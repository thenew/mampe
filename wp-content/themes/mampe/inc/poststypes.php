...
function custom_posts_types() {
	...
	$coverLabels = array(
		'name' => 'Couverture',
		'singular_name' => 'Couverture',
		'add_new' => 'Ajouter un couverture',
		'add_new_item' => 'Ajouter un couverture',
		'edit_item' => 'Modifier un couverture',
		'new_item' => 'Nouveau couverture',
		'view_item' => 'Afficher un couverture',
		'search_items' => 'Chercher un couverture',
		'not_found' =>  'Rien trouvé',
		'not_found_in_trash' => 'Rien trouvé dans la corbeille'
	);
	...
	register_post_type('cover', $coverArgs);
